...
<form method="POST" action="{{ route('institucion_int.update', $instInt) }}" class="form-inst border border-2 rounded-3 shadow-lg ">
    ...
    <div class="row mt-4">
        <div class="offset-1 col-10">
            <input type="text" class="form-control border border-dark " placeholder="* Nombre de la institución o entidad..." id="instentnameInt" name="instentnameInt" value="{{ $instInt->nombre }}">
    ...
    <div class="row mt-4">
        <div class="offset-1 col-10">
            <input type="text" class="form-control border border-dark " placeholder="* País..." id="inst_paisInt" name="inst_paisInt" value="{{ $instInt->pais }}">
            @error('inst_paisInt')
                <span style="color: red">*{{ $message }}</span>    
            @enderror
        </div>
    ...
    <div class="row mt-4">
        <div class="offset-1 col-10">
            <input type="email" class="form-control border border-dark " placeholder="* Email..." id="int_emailInt" name="int_emailInt" value="{{ $instInt->email }}">
            @error('int_emailInt')
                <span style="color: red">*{{ $message }}</span>    
            @enderror 
        </div>
